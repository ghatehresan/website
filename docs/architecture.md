...
Production WP: WoodMart + Elementor + WooCommerce؛ در بررسی اولیه کالای demo الکترونیکی، پس از پاک‌سازی مالک ۰ کالای منتشرشده در API عمومی
...
1. **امروز:** هیچ سورس واقعی محصول از منابع موجود تأیید نشد؛ محصولات demo ووکامرس پس از اقدام مالک از API عمومی حذف شده‌اند و seed مدیریت غیرقابل انتشار تخصصی است؛ اطلاعات سفارش/DB عملیاتی نامعلوم‌اند.
