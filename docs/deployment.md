...
**این مخزن فعلاً وردپرس قابل استقرار ندارد.** نسخهٔ موجود شامل [اسناد ممیزی](phase-1-audit.md) و [پیش‌نمایش ایزولهٔ رابط](../prototype/README.md) است؛ پیش‌نمایش، child theme یا plugin نیست. Production به Git این مخزن متصل/تطبیق داده نشده و هیچ فایل vendor یا دیتابیس در آن نیست. نباید با push این branch فرض کرد سایت زنده تغییر کرده است.
