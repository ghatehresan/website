...
|---|---|---|
| P0 عملیاتی | [فروشگاه زنده](https://ghatehresan.ir/shop/) کالای demo قیمت‌دار/قابل افزودن دارد؛ [صفحه تماس](https://ghatehresan.ir/our-contacts/) و [سیاست ارسال](https://ghatehresan.ir/delivery-return-2/) اطلاعات/قول‌های demo نشان می‌دهند | مالک پس از بکاپ و بررسی سفارش‌ها دربارهٔ توقف فروش demo و حذف ادعاهای اثبات‌نشده تصمیم بگیرد؛ اطلاع‌رسانی به مشتریان احتمالی |
